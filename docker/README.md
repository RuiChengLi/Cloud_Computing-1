...
* 获取docker官方脚本下载
  ...
  >
  > ![3](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/3.png)
...
* 用systemctl命令启动docker守护进程(服务器)
  ...
  >
  > ![4](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/4.png)
  >
  > //检查版本
  >
  > docker version
  >
  > ![6](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/6.png)

* 自启动

  > systemctl enable docker
  >
  > ![5](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/5.png)
...
* 拉到本服务器
  ...
  > docker pull centos
  >
  > ![7](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/7.png)
...
* 尝试跑一下镜像
  ...
  > //在仓库里检查是不是有这个镜像了
  >
  > ![8](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/8.png)
  >
  > exit
  >
  > docker images
  >
  > ![9](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/9.png)
...
>
> ![32_solution](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/32_solution.png)
...
>
> ![21](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/21.png)
...
>
> ![22](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/22.png)

### 下载并配置apache服务器

> yum install httpd
>
> ![23](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/23.png)
>
> //开启apache服务器
>
...
>
> ![24](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/24.png)
...
>
> ![25](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/25.png)
>
> //开启数据库守护进程并设置自启动
>
> systemctl start mariadb
>
> ![26](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/26.png)
>
> systemctl enable mariadb
>
> ![27](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/27.png)
>
> //设置数据库
>
...
> ### 配置
>
> ![db1](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/db1.png)
>
> 
>
> 
...
>
> ![28](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/28.png)
>
> yum intstall http://rpms.remirepo.net/enterprise/remi-release-7.rpm
>
> yum-config-manager  --enable remi-php72
>
> ![30](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/30.png)
>
> //安装php的数据库文件
>
> yum install php php-mysql
>
> ![31](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/31.png)
...
> yum install git
>
> ![wd1](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd1.png)
>
> git clone http://gitee.com/helang_z/wordpress.git
>
> ![wd2](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd2.png)
>
> cd wordpress
>
> ![wd3](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd3.png)
>
...
> vi wp-config.php
>
> ![wd4](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd4.png)
>
> //根据之前配置的数据库信息，修改DB_NAME、DB_PASSWORD、DB_HOST
>
> ![wd5](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd5.png)

#### 登录wordpress

> //根据提示，修改信息，完成搭建。
>
> ![wd6](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/wd6.png)
>
...
![hub1](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/hub1.png)

> 在本地提交
>
> 格式 :docker commit -m "提交信息" -a "用户名" 容器ID  仓库名:标签 //将容器推送到指定的仓库

![hb2](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/hb2.png)

> docker images 可以查看到前面前面的信息
>
> 再键入 docker tag IMAGE_ID 用户名/仓库名

![hb3](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/hb3.png)

> 再次输入docker images 可以查看到tag的仓库

![hb4](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/hb4.png)
...
![hb5](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/hb5.png)

### 结果 

![result](https://github.com/sonettofighting/Cloud_Computing/blob/master/docker/images/result.jpg)
...
<<<<<<< HEAD
# 特别鸣谢：八九bro、Professior 杨
=======
#感谢感谢898989898989989898989！and  professor yang
>>>>>>> 027f46459107ca7a83c51c2581b01f1a8e518869
